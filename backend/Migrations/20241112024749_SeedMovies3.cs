    ...
    public partial class SeedMovies3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Florence Pugh, Saoirse Ronan", "An 18th birthday mushroom trip brings free-spirited Elliott face-to-face with her wisecracking 39-year-old self...", "Greta Gerwig", "/yUs4Sw9AyTg2sA1qWBkNpD2mGSj.jpg", 6.5999999999999996, new DateTime(2024, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "trending", "My Old Ass", "movie", "Greta Gerwig" },
                    { 2, "Joaquin Phoenix, Lady Gaga", "While struggling with his dual identity, Arthur Fleck not only stumbles upon true love, but also finds the music that's always been inside him.", "Todd Phillips", "/if8QiqCI7WAGImKcJCfzp6VTyKA.jpg", 5.6509999999999998, new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "trending", "Joker: Folie à Deux", "movie", "Todd Phillips, Scott Silver" },
                    { 3, "Adam Driver, Nathalie Emmanuel", "Genius artist Cesar Catilina seeks to leap the City of New Rome into a utopian, idealistic future...", "Francis Ford Coppola", "/8Sok3HNA3r1GHnK2lCytHyBz1A.jpg", 5.5999999999999996, new DateTime(2024, 9, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "trending", "Megalopolis", "movie", "Francis Ford Coppola" },
                    { 4, "Edward Fox, Michael Lonsdale", "An unrivalled and highly elusive lone assassin, the Jackal, makes his living carrying out hits...", "Jean-Pierre Melville", "/tYLecM3WSEjlkKhkGiH5G68Dprm.jpg", 7.9000000000000004, new DateTime(2024, 11, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "trending", "The Day of the Jackal", "tv", "Frederick Forsyth" },
                    { 5, "Richard Madden, Priyanka Chopra", "When stuntman Bunny recruits struggling actress Honey for a side gig, they are hurled into a high-stakes world...", "Anthony Russo", "/lzZ9J2FOsaq1DCuD7k2f4ogbXdD.jpg", 7.5, new DateTime(2024, 11, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "trending", "Citadel Honey Bunny", "tv", "Josh Appelbaum, Bryan Oh" },
                    { 6, "Voice of Roz, various animal voices", "After a shipwreck, an intelligent robot called Roz is stranded on an uninhabited island...", "Chris Sanders", "/wTnV3PCVW5O92JMrFvvrRcV39RU.jpg", 8.5120000000000005, new DateTime(2024, 9, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "trending", "The Wild Robot", "movie", "Peter Brown" },
                    ...
                    { 16, "Dwayne Johnson, Chris Evans", "After Santa Claus (codename: Red One) is kidnapped, the North Pole's Head of Security must team up with the world's most infamous bounty hunter in a globe-trotting, action-packed mission to save Christmas.", "Jake Kasdan", "/cdqLnri3NEGcmfnqwk2TSIYtddg.jpg", 6.9000000000000004, new DateTime(2024, 10, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Red One", "movie", "Chris Morgan" },
                    { 17, "Jim Caviezel, Guy Pearce", "Edmond Dantes becomes the target of a sinister plot and is arrested on his wedding day for a crime he did not commit. After 14 years in the island prison of Château d’If, he manages a daring escape. Now rich beyond his dreams, he assumes the identity of the Count of Monte-Cristo and exacts his revenge on the three men who betrayed him.", "Kevin Reynolds", "/zw4kV7npGtaqvUxvJE9IdqdFsNc.jpg", 8.3000000000000007, new DateTime(2024, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "The Count of Monte-Cristo", "movie", "Alexandre Dumas" },
                    { 18, "Tom Hardy, Michelle Williams", "Investigative journalist Eddie Brock attempts a comeback following a scandal, but accidentally becomes the host of Venom, a violent, super powerful alien symbiote. Soon, he must rely on his newfound powers to protect the world from a shadowy organization looking for a symbiote of their own.", "Ruben Fleischer", "/2uNW4WbgBXL25BAbXGLnLqX71Sw.jpg", 6.7999999999999998, new DateTime(2018, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Venom", "movie", "Jeff Pinkner, Scott Rosenberg" },
                    { 19, "Tom Hardy, Woody Harrelson", "After finding a host body in investigative reporter Eddie Brock, the alien symbiote must face a new enemy, Carnage, the alter ego of serial killer Cletus Kasady.", "Andy Serkis", "/1MJNcPZy46hIy2CmSqOeru0yr5C.jpg", 6.7999999999999998, new DateTime(2021, 9, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Venom: Let There Be Carnage", "movie", "Kelly Marcel" },
                    { 20, "Steve Carell, Taraji P. Henson", "Gru and Lucy and their girls—Margo, Edith and Agnes—welcome a new member to the Gru family, Gru Jr., who is intent on tormenting his dad. Gru also faces a new nemesis in Maxime Le Mal and his femme fatale girlfriend Valentina, forcing the family to go on the run.", "Kyle Balda", "/wWba3TaojhK7NdycRhoQpsG0FaH.jpg", 7.0999999999999996, new DateTime(2024, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Despicable Me 4", "movie", "Matthew Fogel" },
                    { 21, "Nicolas Duvauchelle, Mélanie Thierry", "A couple celebrates their son’s birthday in the middle of the ocean on their boat. A violent storm hits and it brings up hungry creatures from the depths and they fight for their survival.", "Éric Rochant", "/7fR3KxswtY8OHHZuOUB9td58CRX.jpg", 5.0, new DateTime(2024, 6, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Survive", "movie", "Éric Rochant" },
                    { 22, "Sophie Turner, Matthew Goode", "A burned-out professional sniper finds himself trapped in an all-glass penthouse by a lethal competitor and must find a way to survive and escape with little to no cover between him and the killer.", "Tom Paton", "/xNLiMNyFzKTL9PVIEulG55Hei8j.jpg", 6.5999999999999996, new DateTime(2024, 10, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Take Cover", "movie", "Tom Paton" },
                    { 23, "Jessica Chastain, John Boyega", "Top level CIA agent Avery Graves is blackmailed by terrorists into betraying her own country to save her kidnapped husband. Cut off from her team, she turns to her underworld contacts to survive and help locate the coveted intelligence that the kidnappers want.", "Mark Williams", "/hhiR6uUbTYYvKoACkdAIQPS5c6f.jpg", 6.2999999999999998, new DateTime(2024, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Canary Black", "movie", "Mark Williams" },
                    { 24, "Not Available", "Amid the stark discord of twin cities Piltover and Zaun, two sisters fight on rival sides of a war between magic technologies and clashing convictions.", "Not Available", "/q8eejQcg1bAqImEV8jh8RtBD4uH.jpg", 8.8000000000000007, new DateTime(2021, 11, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "banner", "Arcane", "tv", "Not Available" },
                    { 25, "Not Available", "A fading celebrity decides to use a black market drug, a cell-replicating substance that temporarily creates a younger, better version of herself.", "Not Available", "/7h6TqPB3ESmjuVbxCxAeB1c9OB1.jpg", 7.2999999999999998, new DateTime(2024, 9, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "banner", "The Substance", "movie", "Not Available" },
                    { 26, "Not Available", "With the city in peril following the seawall's collapse, Oswald \"Oz\" Cobb’s quest seeks to fill the power vacuum left by the death of Carmine Falcone and finally give his mother Francis the life he's always promised. But first, Oz must confront his enemies and his own demoralizing reputation as \"the Penguin.\"", "Not Available", "/qq36sU5xH581RiNEkookMQ9D7yp.jpg", 8.5, new DateTime(2024, 9, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "banner", "The Penguin", "tv", "Not Available" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 845781, "Dwayne Johnson, Chris Evans", "After Santa Claus (codename: Red One) is kidnapped, the North Pole's Head of Security must team up with the world's most infamous bounty hunter in a globe-trotting, action-packed mission to save Christmas.", "Jake Kasdan", "/cdqLnri3NEGcmfnqwk2TSIYtddg.jpg", 6.9000000000000004, new DateTime(2024, 10, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "action", "Red One", "movie", "Chris Morgan" },
